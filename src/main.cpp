...
uint256 hashGenesisBlock("0x581820cb009582cd6e66810f85314f06c32c0fca96b42380a0fd926d9b3cb81a");
static CBigNum bnProofOfWorkLimit = CBigNum().SetCompact(504365644); // MagNo: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "MagNo Signed Message:\n";
...
{
    // MagNo: IsDust() detection disabled, allows any valid dust to be relayed.
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    nSubsidy >>= (nHeight / 840000); // MagNo: 840k blocks in ~4 years

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 10 * 30; // MagNo: 5 minutes
static const int64 nTargetSpacing = 1 * 30; // MagNo: 30 seconds
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    // MagNo: This fixes an issue where a 51% attack can change difficulty at will.
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // MagNo: Special short-term limits to avoid 10,000 BDB lock limit:
...
{
    // MagNo: temporarily disable v2 block lockin until we are ready for v2 transition
    return false;
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x581820cb009582cd6e66810f85314f06c32c0fca96b42380a0fd926d9b3cb81a");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "MagNo Crypto Currency";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CBigNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 1000000000;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("553fdc8a1381367ab65c129bb0d6d7904571d663b5c1da9b445d3698fa0735939483c7ec42460c36872593f6cb050fcc787752f84947013706e75768b57b726d8e") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1535062989;
        ...
        assert(block.hashMerkleRoot == uint256("0xd86f40a6c9b87ec16bf514c56f7d442a1ee7051a7d8b901c27c73ee1708bf47b"));
...
unsigned char pchMessageStart[4] = { 0xfb, 0xc0, 0xb6, 0xdb }; // MagNo: increase each by adding 2 to bitcoin's value.
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("MagNoMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("MagNoMiner : ProcessBlock, block not accepted");
    }
